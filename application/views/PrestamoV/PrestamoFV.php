              ...
              <div class="card-body">
                 <table id="tabla" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <th class="bg-secondary">Fecha de devolucion</th>
                    <th class="bg-secondary">Hora de devolucion</th>
                  </tr>
                  </thead>
                  <tbody>
                    <?php 
                      if(!empty($prestamosFinalizados)):?>
                        <?php 
                          foreach ($prestamosFinalizados as $key):
                        ?>
                        <tr>
                          ...
                          <td style="font-size: 14px;"><?php echo $key->Fecha_devolucion; ?></td>
                          <td style="font-size: 14px;"><?php echo $key->Hora_devolucion; ?></td>
                        </tr>
                        <?php endforeach; ?>
                      <?php endif; ?>
                  </tbody>
